              ...
              <div class="col-lg-12">
                  <div class="form-panel">
                      ...
                      <?php
                        ...
                        <?php } ?>
                      <form id="formTransaksi" action="<?= base_url('operator/transaksi_simpan')?>" class="form-horizontal style-form" method="post" enctype="multipart/form-data">
                        <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-2">
                                <a class="btn btn-sm btn-info" href="<?= base_url('operator/pelanggan_tambah')?>" data-toggle="tooltip" data-placement="bottom" title="Tambah Pelanggan Baru"><i class="fa fa-plus"></i></a>
                              </div>
                          </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-4">
                                ...
                                <a href="<?= base_url('operator/transaksi_batal') ?>" class="btn btn-danger btn-lg">Batal</a>
                            </div>
                        </div>
                      </form>
                  </div><!-- /content-panel -->
            ...
            <script type="text/javascript">
              $(function(){
                ...
                $('#pelanggan').change(function(event){
                  ...
                  var id=this.value;
                  $.ajax({
                    url:"<?php echo base_url('operator/transaksi_get_pelanggan')?>",
                    type:"post",
                    data:{id:id},
                ...
                $('#kode_barang').change(function(event){
                  ...
                  $.ajax({
                    url:"<?php echo base_url('operator/pesanan_get_barang')?>",
                    type:"post",
                    data:{kode:kode},
                    dataType:'json',
                    success: function(response) {
                ...
                $('#formPesananSubmit').click(function(event){
                  ...
                  if ($("#kode_barang").val().length > 0 && $("#jumlah").val().length > 0 ) {
                    ...
                    $.ajax({
                      url:"<?php echo base_url('operator/pesanan_tmp_tambah')?>",
                      type:"post",
                      data:data,
                      success: function() {
                        resetFormPesanan();
                ...
                function loadTabelPesananTMP(){
                  $.ajax({
                    url:"<?php echo base_url('operator/pesanan_tmp')?>",
                    dataType:"json",
                    success: function(response) {
                ...
                $('#table_pesanan').on('click','.hapus',function(event) {
                  ...
                  var id = $(this).attr('id');
                  $.ajax({
                    url:"<?php echo base_url('operator/pesanan_tmp_hapus')?>"+"/"+id,
                    success: function() {
                      loadTabelPesananTMP();
                    },
                    error: function() {
