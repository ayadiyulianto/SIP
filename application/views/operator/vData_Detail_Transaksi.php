            ...
            <div class="row mt">
              <div class="col-lg-12">
                  <div class="form-panel form-horizontal style-form">
                      <h3><i class="fa fa-angle-right"></i> Detail Transaksi <a href="<?= base_url('operator/transaksi_cetak/'.$transaksi->id) ?>" target="_blanks" class="btn btn-info"><i class="fa fa-print"></i> Cetak Transaksi</a></h3>
                      ...
                      <?php
                        ...
                        <div class="col-lg-6">
                          ...
                          <form id="formUbah" action="<?= base_url('operator/transaksi_ubah/'.$transaksi->id)?>" method="post">
                          <?php if($sisa>0){?>
                          <div class="form-group">
