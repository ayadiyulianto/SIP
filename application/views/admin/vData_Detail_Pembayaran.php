                  ...
                  <div class="col-md-12 col-lg-12">
                      <div class="content-panel col-md-12 col-lg-12">
                          <?php
                            ...
                            <div class="row">
                              <div class="col-lg-2"><h5>Status Penghuni</h5></div>
                            ...
                            <table class="myTable table table-bordered table-striped table-condensed table-hover">
                              ...
                              <tr>
                                  ...
                                  <th>Jumlah</th>
                                  <th>Lampiran</th>
                                  <th width="15%"><?php if($pembayaran->sisa > 0){ ?><a class="btn btn-sm btn-info " href="<?= base_url('admin/tambah_pembayaran/'.$pembayaran->id_penghuni)?>"><i class="fa fa-plus"></i> Tambah Data</a><?php }?></th>
                              </tr>
                              </thead>
                              <tbody>
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <a class="btn btn-sm btn-primary" href="<?= base_url('admin/edit_pembayaran/'.$row->id_pembayaran)?>"><i class="fa fa-edit "> Ubah</i></a>
                                  </td>
                              </tr>
                              <?php }?>
                              </tbody>
