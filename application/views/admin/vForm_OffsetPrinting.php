              ...
              <div class="col-lg-12">
                  <div class="form-panel">
                      <form action="<?= base_url('admin/offsetprinting_simpan')?>" class="form-horizontal style-form" method="post" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            <label class="col-lg-2 control-label">Jenis Cetakan</label>
                            <div class="col-lg-10">
                                <input type="text" placeholder="Jenis Cetak" name="nama_cetak" class="form-control" <?php if(isset($data)) echo 'value="'.$data['nama_cetak'].'"'?> required="required">
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="col-lg-6">
                            <div class="form-group">
                              <label class="col-lg-4 control-label">Harga Modal</label>
                              <div class="col-lg-4">
                            ...
                            <div class="form-group">
                              <label class="col-lg-4 control-label">Harga Umum</label>
                              <div class="col-lg-4">
                          ...
                          <div class="col-lg-6">
                            <div class="form-group">
                              <label class="col-lg-4 control-label">Harga Reseller</label>
                              <div class="col-lg-4">
                            ...
                            <div class="form-group">
                              <label class="col-lg-4 control-label">Harga Agent</label>
                              <div class="col-lg-4">
